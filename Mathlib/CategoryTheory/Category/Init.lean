...
meta register_option mathlib.tactic.category.grind : Bool := {
  defValue := false
...
meta register_option mathlib.tactic.category.log_grind : Bool := {
  defValue := false
...
meta register_option mathlib.tactic.category.log_aesop : Bool := {
  defValue := false
