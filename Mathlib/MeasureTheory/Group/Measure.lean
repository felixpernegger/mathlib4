...
theorem _root_.MulEquiv.isHaarMeasure_map [BorelSpace G] [ContinuousMul G] {H : Type*}
  ...
  Measure.isHaarMeasure_map μ e.toMonoidHom he e.surjective
    f.isClosedEmbedding.tendsto_cocompact
